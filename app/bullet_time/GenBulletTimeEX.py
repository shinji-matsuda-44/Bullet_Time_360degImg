...
import subprocess
import numpy as np
from bullet_time import GenProjectedImgEX
...
class GenBulletTimeEX:
    ...
    def generate_bullet_time(self):
        ...
        for i in range(len(path_img_files)):
            ...
            GPI = GenProjectedImgEX.GenProjectedImgEX(path_img, THETA, PHI, theta_eye=theta_eye, phi_eye=phi_eye, \
